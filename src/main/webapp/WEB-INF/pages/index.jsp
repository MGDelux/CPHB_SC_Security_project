    ...
    <div class="row row-cols-1 row-cols-md-5">
                ...
                <div>
                    ...
                    <div class="col">
                        <div class="card bg-dark">
                            ...
                            <div class="Addcupcake">
                                <button class="btn btn-secondary" name="AddCupcakeToKurv" type="submit">Tilføj til
                                    kurv
                                </button>
                            </div>
                            <!__ Modal button2 starter her -->
                            <div>
                            ...
                            <!__ Modal button2 slutter her -->

                            <!__ Modal content2 starter her -->
                            <div>
                                <div class="modal fade" id="Modal2" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content bg-dark">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">vanilje cupcake</h5>
        ...
        <div class="col">
                        <div class="card bg-dark bg-dark text-white">
                            ...
                            <!__ Modal button3 slutter her -->

                            <!__ Modal content3 starter her -->
                            <div>
                                <div class="modal fade" id="Modal3" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content bg-dark">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle3">jordbær
                                                    sprinkle</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
        ...
        <div class="col">
                                <div class="card bg-dark bg-dark text-white">
                                    ...
                                    <div class="Addcupcake">
                                        <button class="btn btn-secondary" name="AddCupcakeToKurv" type="submit">Tilføj
                                            til kurv
                                        </button>
                                    </div>
                                    <!__ Modal button4 starter her -->
                                    <div>
                                        <button type="button" class="btn btn-secondary" data-toggle="modal"
                                                data-target="#Modal4">
                                            Se mere
                                    ...
                                    <!__ Modal button4 slutter her -->

                                    <!__ Modal content4 starter her -->
                                    <div>
                                        <div class="modal fade" id="Modal4" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content bg-dark">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle4">Blåbær
                                                            cupcake</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        ...
                                                        <div class="card bg-dark">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-secondary"
                                                                        name="AddCupcakeToKurv" type="submit">Tilføj til
                                                                    kurv
                                                                </button>
                                                            </div>
                                                        </div>
        ...
        <div class="col">
                                        <div class="card bg-dark bg-dark text-white">
                                            ...
                                            <!__ Modal button5 slutter her -->

                                            <!__ Modal content5 starter her -->
                                            <div>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content bg-dark">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="card bg-dark">
                                                                    <img src="http://cdn.sallysbakingaddiction.com/wp-content/uploads/2017/06/moist-chocolate-cupcakes-5.jpg"
                                                                         width="35" height="250" class="card-img-top"
                                                                         alt="...">
                                                                    <div class="card-body bg-dark text-white">
                                                                        <h5 class="card-title">Kanel cupcake</h5>
                                                                        <p class="card-text">This is a longer card with
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button class="btn btn-secondary"
                                                                                name="AddCupcakeToKurv" type="submit">
                                                                            Tilføj til kurv
                                                                        </button>
                                                                    </div>
                                                                </div>
        ...
        <div class="col">
                                                <div class="card bg-dark bg-dark text-white">
                                                    ...
                                                    <!__ Modal button6 slutter her -->

                                                    <!__ Modal content6 starter her -->
                                                    <div>
                                                                ...
                                                                <div class="modal-content bg-dark">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="exampleModalLongTitle6">Vegan
                                                                            cupcake</h5>
