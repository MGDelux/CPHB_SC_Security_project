            ...
            <div class="col">
                <div class="card bg-dark">
                    ...
                    <div class="card-body bg-dark text-white">
                        ...
                        <p class="card-text">${product.productDescription} - ${product.productPrice} kr.</p>
                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content bg-dark">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle2">test</h5>
                                            ...
                                            <div class="card bg-dark">
                                                ...
                                                <div class="card-body bg-dark text-white">
                                                    ...
                                                    <p class="card-text">${productInformation.productDescription}
                                                        - ${productInformation.productPrice} kr.</p>
                                                </div>
                                                <div id="comment">
